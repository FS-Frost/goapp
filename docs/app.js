...
// Env
// -----------------------------------------------------------------------------
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/goapp","GOAPP_STATIC_RESOURCES_URL":"/goapp","GOAPP_VERSION":"d3bb6dd0e63f618ac3d3e1b79736484cce533af8"};
...
if (!/bot|googlebot|crawler|spider|robot|crawling/i.test(navigator.userAgent)) {
  ...
  WebAssembly.instantiateStreaming(fetch("/goapp/web/app.wasm"), go.importObject)
    .then(result => {
